...
class Educhain::Pages::Index::Component < Educhain::BaseComponent
  include Educhain::Layout::PageHelpers
  ...
  def prev_page_path
    url_for(**request.params, page: @page.number - 1, only_path: true) unless @page.first?
  end

  def next_page_path
    url_for(**request.params, page: @page.next_param, only_path: true) unless @page.last?
  end
