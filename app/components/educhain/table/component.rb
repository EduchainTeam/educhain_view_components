...
class Educhain::Table::Component < Educhain::BaseComponent
  ...
  def selectable_column
    @selectable_column ||= Column.new(
      header: -> {
        Educhain::Checkbox::Component.new(
  ...
  def render_batch_action_button(batch_action)
    ...
    if batch_action.require_confirmation
      ...
      params["data-#{stimulus_id}-message-param"] = "Action confirmation"
    ...
    render Educhain::Button::Component.new(**params)
  end
