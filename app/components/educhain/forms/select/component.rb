...
class Educhain::Forms::Select::Component < Educhain::BaseComponent
  FONT_SIZES = {
  ...
  def before_render
    @attributes[:"data-loading-message"] ||= "loading"
    @attributes[:"data-loading-more-message"] ||= "loading_more"
    @attributes[:"data-no-results-message"] ||= "no_results"
  end
