...
class Educhain::Forms::SelectComponentPreview < ViewComponent::Preview
  ...
  def remote_with_pagination(multiple: false, latency: false, loading_message: nil, loading_more_message: nil, no_results_message: nil)
    ...
    render Educhain::Forms::Select::Component.new(**args)
  end
  ...
  def playground(size: "m", options: 3, multiple: false, selected: false, disabled: false, error: false, include_blank: false, blank_option: nil, placeholder: nil, hint: nil, tip: nil)
    ...
    render Educhain::Forms::Select::Component.new(
      label: "Label",
      name: "select",
      hint:,
      tip:,
